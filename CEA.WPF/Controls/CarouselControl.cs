...
namespace SJB.MeritViewer.Controls
    ...
    public double RotationSpeed
		...
		private const double MINIMUM_FADE = 0.0;
		private const double MAXIMUM_FADE = 1.0;
		...
		private const double MINIMUM_SCALE = 0.0;
		private const double MAXIMUM_SCALE = 1.0;
